...
gay=MsgBox ("Sorry!!! You must be online to register or there must be some critical error.",vbYesNo+vbOK+vbCritical,"Quizzer v1.0")
End If
Loop While gay=vbRetry 
If IsEmpty(gay) Or gay=vbCancel Then WScript.Quit
'SURVEY completed
fso.CreateTextFile("user.qz")
fso.CreateTextFile("qn.qz")
Do
x=x+1
x2=Cstr(x)
x3="q"&x2&".qz"
